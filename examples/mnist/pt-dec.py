...
class CachedMNIST(Dataset):
    def __init__(self, train, cuda, testing_mode=False):
        ...
        dataset = pd.read_csv(
            'C:/Users/r0rschach/Desktop/IK/New folder/GSE28435.csv')
...
@ click.option(
    "--batch-size", help="training batch size (default 256).", type=int, default=1
)
@ click.option(
    "--pretrain-epochs",
...
def main(cuda, batch_size, pretrain_epochs, finetune_epochs, testing_mode):
    ...
    autoencoder = StackedDenoisingAutoEncoder(
        [ds_train.ds[0][0].shape[0], 500, 500, 2000, 10], final_activation=None
    )
